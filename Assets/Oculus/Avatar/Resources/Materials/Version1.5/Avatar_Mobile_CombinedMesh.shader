...
Shader "OvrAvatar/Avatar_Mobile_CombinedMesh"
{
	...
	SubShader
	{
		Pass
		{
			...
			{
				// Light directions
				float lightDirection = _WorldSpaceLightPos0.xyz;
				...
				// Illuminate from behind with an intensity drop
				...
				col.rgb += pow(1.0 - VdotN, _RimIntensity[componentIndex] * SECONDARY_LIGHT_RIM_SCALE) * NdotL * _SecondaryLightColor;
#else
